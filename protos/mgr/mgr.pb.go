...
func (x *CloseRoomNot) Reset() {
	*x = CloseRoomNot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_mgr_mgr_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CloseRoomNot) Descriptor() ([]byte, []int) {
	return file_protos_mgr_mgr_proto_rawDescGZIP(), []int{5}
}
...
var file_protos_mgr_mgr_proto_rawDesc = []byte{
	...
	0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x22, 0x20, 0x0a, 0x0c, 0x43,
	0x6c, 0x6f, 0x73, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x4e, 0x6f, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x72,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x69, 0x64, 0x62, 0x06, 0x70,
...
var file_protos_mgr_mgr_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_protos_mgr_mgr_proto_goTypes = []interface{}{
	...
	(*CloseRoomNot)(nil),   // 5: proto.mgr.CloseRoomNot
}
...
func file_protos_mgr_mgr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_mgr_mgr_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
